...
languageLinkES.addEventListener('click', (e) => {
    ...
    <div class="page" id="fourth-page">
        <div id="fourth-page-items">
            ...
            <a class="page-link" href="https://www.canva.com/design/DAE-32KJ8Do/b-uhGMiZ621qZBJ94Fuj-g/view">+fotos</a>
        </div>
    </div>
...
languageLinkEN.addEventListener('click', (e) => {
    ...
    <div class="page" id="fourth-page">
        <div id="fourth-page-items">
            ...
            <a class="page-link" href="https://www.canva.com/design/DAE-32KJ8Do/b-uhGMiZ621qZBJ94Fuj-g/view">+photos</a>
        </div>
    </div>
